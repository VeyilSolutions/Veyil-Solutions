      ...
      <div className="mx-auto max-w-7xl">
        ...
        {variant === "home" && (
          <div className="mt-12 text-center sm:mt-16">
            <Link
              to="/blogs"
              className="group relative inline-flex items-center gap-2 overflow-hidden border-2 border-black 
                         px-6 py-3 text-xs font-bold uppercase tracking-widest text-black 
                         transition-colors duration-300 hover:text-white 
                         sm:px-10 sm:py-4 sm:text-base sm:font-black
